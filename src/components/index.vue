...
<style scoped>
  ...
  .moviesList li .right .fraction{font-size: 20px; color: #f60; height: 34px; line-height: 34px;}
  ...
  .moviesList li .intro .name{ text-decoration: none; color: #333; overflow: hidden; white-space: nowrap; text-overflow: ellipsis; height: 34px; line-height: 34px; font-size: 16px;}
